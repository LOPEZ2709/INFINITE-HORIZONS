...
$sql_seguridad = "INSERT INTO seguridad (email_usu, contra_usu) VALUES ('$email', '$contraseña')";
...
$sql_usuario = "INSERT INTO usuario (nombre_usu, apellido_usu, telefono_usu, email_usu, fecha_registro, estado, genero, localidad, fecha_nacimiento, contra_usu, documento, id_estado, id_seguridad)
                VALUES ('$nombre', '$apellidos', '$telefono', '$email', NOW(), 'activo', '$genero', '$localidad', '$fecha', '$contraseña', '$documento', '$id_estado', '$id_seguridad')";
...
$sql =  "SELECT * FROM usuario WHERE email_usu = '$email' and contra_usu = '$contraseña'";
