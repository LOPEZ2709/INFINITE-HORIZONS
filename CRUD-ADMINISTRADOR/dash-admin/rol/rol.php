    ...
    <tbody>
        <?php foreach ($roles as $rol): ?>
            <tr>
                ...
                <td>
                    <a href="actualizar-rol.php?idRol=<?php echo $rol['idRol']; ?>">Actualizar</a>
                    <a href="eliminar-rol.php?idRol=<?php echo $rol['idRol']; ?>">Eliminar</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
<a href="insertar-rol.php">Registrar Nuevo Rol</a>
