...
import "./login.css";
import Swal from "sweetalert2"; // Para mejor retroalimentación al usuario
...
function Register() {
    ...
    const handleRegisterSubmit = async (e) => {
        ...
        try {
            ...
            if (result.message === "Documento de identidad inválido") {
                Swal.fire({
                    icon: "error",
                    title: "Error",
                    text: "El documento de identidad es inválido",
                });
                ...
                Swal.fire({
                    icon: "error",
                    title: "Error",
                    text: result.message || "Hubo un error al registrar.",
                });
            }
        } catch (error) {
